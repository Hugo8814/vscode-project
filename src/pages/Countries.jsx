    ...
    <div className={styles.pfa}>
      ...
      <div className={styles.box}>
        ...
        <ul className={styles.desc}>
          ...
          <li className={styles.text}>
            The app utilizes a country information API to fetch data and display
            it to users.
          </li>
          <li className={styles.text}>
            Its designed to be simple, showcasing my ability to build with
            Vanilla JavaScript and manage API data.
          </li>
        </ul>
      </div>
      ...
      <div className={styles.box}>
        <ul className={styles.desc}>
          ...
          <li className={styles.text}>
            Built using Vanilla JavaScript following the MVC architecture
            pattern.
          </li>
          <li className={styles.text}>
      ...
      <div className={styles.box}>
        ...
        <ul className={styles.desc}>
          ...
          <li className={styles.text}>
            Simple API integration to display country data in a clean,
          ...
          <li className={styles.text}>
            Technologies used: HTML5, CSS3, SASS, Vanilla JavaScript, Flexbox,
            CSS Grid.
          </li>
          <li className={styles.text}>
